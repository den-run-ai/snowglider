...
// Anamorphic lens flare — AnamorphicNode.js was removed in r184.
// r183 only: import { anamorphic } from 'three/addons/tsl/display/AnamorphicNode.js';
// r184+: use bloom() with a custom high pass filter for anamorphic effects
